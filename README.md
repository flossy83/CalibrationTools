...
* **Note: sunrise-sunset.org appears to be currently having an issue with its https certificate which can cause a Windows OS error message popup when Calibration Tools tries to update dawn and dusk times.  Until sunrise-sunset.org corrects the issue, you may avoid it by setting HTTPS=0 in Config.ini.**
